...
def canais():
	...
	addDir("Brazzers TV",'-',4,artfolder + "brazzers.png",False)
	addDir("Brasileirinhas",'-',5,artfolder + "brasileirinhas.png",False)
	addDir("SexyHot",'-',6,artfolder + "sexyhot.png",False)
	addDir("Playboy TV",'-',7,artfolder + "playboy.png",False)
	addDir("Playboy TV Chat",'-',8,artfolder + "playboyhd.png",False)
	addDir("Penthouse HD",'-',9,artfolder + "penthouse.png",False)
	#addDir("Hot",'-',10,artfolder + "hot.png",False)
	addDir("Hustler HD",'-',11,artfolder + "hustlerhd.png",False)
	addDir("Viki Enjoy Premium",'-',12,artfolder + "viki.png",False)
	addDir("Viet Sex TV",'-',13,artfolder + "vietsextv.png",False)
	addDir("Bella Club",'-',14,artfolder + "bellaclub.png",False)
	addDir("Bella Club 2",'-',15,artfolder + "bellaclub2.png",False)
	addDir("ButGO",'-',16,artfolder + "butgo.png",False)
	addDir("Filthon Adult",'-',17,artfolder + "filthon.png",False)
	addDir("Filthon Adult Fetish",'-',18,artfolder + "filthonfetish.png",False)
	addDir("XXL",'-',19,artfolder + "xxl.png",False)
	addDir("Frenchlover",'-',20,artfolder + "frenchlover.png",False)
	addDir("Dorcel TV",'-',23,artfolder + "dorceltv.png",False)
	addDir("iPure TV",'-',24,artfolder + "ipuretv.png",False)
	addDir("Private",'-',25,artfolder + "private.png",False)
	addDir("Private Gold",'-',26,artfolder + "privategold.png",False)
	addDir("Venus",'-',27,artfolder + "venus.png",False)
	#addDir("xDesire",'-',28,artfolder + "xdesire.png",False)
	#addDir("Blue Hustler",'-',29,artfolder + "hustlerblue.png",False)
	addDir("O-la-la",'-',30,artfolder + "olala.png",False)
	#addDir("Ero XXX",'-',31,artfolder + "eroxxx.png",False)
	addDir("Amateri TV",'-',32,artfolder + "amateritv.png",False)
	addDir("Russian Nights",'-',33,artfolder + "russiannights.png",False)
	addDir("Hustler TV",'-',34,artfolder + "hustlertv.png",False)
	addDir("Sexzone HD",'-',35,artfolder + "sexzonehd.png",False)
	addDir("Redlight HD",'-',36,artfolder + "redlighthd.png",False)
	addDir("Hallo TV",'-',37,artfolder + "hallotv.png",False)
	addDir("Platinum TV",'-',38,artfolder + "platinumtv.png",False)
	addDir("Sexprive Brasileirinhas",'-',40,artfolder + "sexprive.png",False)
	addDir("Nightclub TV",'-',41,artfolder + "nightclub.png",False)
	addDir("Temptation TV",'-',42,artfolder + "temptationtv.png",False)
	if selfAddon.getSetting('gay') == 'false':
		#Conteúdo gay
		addDir("Filthon Gay",'-',39,artfolder + "filthongay.png",False)
	xbmc.executebuiltin("Container.SetViewMode(500)")
